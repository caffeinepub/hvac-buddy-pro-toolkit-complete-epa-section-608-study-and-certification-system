import { VideoRecord, VideoCategory } from '@/types/local';
...
export const curatedVideos: VideoRecord[] = [
  // EPA Core Videos - Parts 1 & 2
  {
    ...
    description: 'Complete overview of EPA Section 608 Core certification requirements, ozone depletion science, and environmental regulations.',
  ...
  },
  {
    ...
    category: VideoCategory.epaCore,
    description: 'Detailed explanation of refrigerant properties, EPA regulations, recovery procedures, and leak detection requirements.',
  ...
  // EPA Type I Videos
  {
    ...
    description: 'Complete guide to Type I certification covering small appliance systems (5 lbs or less refrigerant), hermetic compressors, and recovery procedures.',
    url: 'https://youtu.be/wZH058B3x54?si=Is3oAJlyG42NULjK',
    linkedLessonTopic: 'Type I - Small Appliance Systems',
    duration: BigInt(1650),
  ...
  // EPA Type II Videos
  {
    ...
    description: 'Comprehensive guide to Type II certification for high-pressure systems including residential and commercial AC systems, R-410A service, and leak repair requirements.',
  ...
  // EPA Type III Videos
  {
    ...
    description: 'Complete guide to Type III certification covering low-pressure systems, centrifugal chillers, purge units, and R-123 safety procedures.',
  ...
  // HVAC Fundamentals Videos
  {
    ...
    description: 'Complete 3D visualization of the vapor-compression refrigeration cycle with component interactions and thermodynamic processes.',
  ...
  },
  {
    ...
    category: VideoCategory.hvacFundamentals,
    description: 'Understanding TXV, EEV, and capillary tube metering devices and how they control refrigerant flow in HVAC systems.',
    url: 'https://youtu.be/qV-DIqIxPGk?si=Orvlt9DFSDOdpbJx',
    linkedLessonTopic: 'Fundamentals - Metering Devices',
    duration: BigInt(1950),
  ...
  },
  {
    ...
    category: VideoCategory.hvacFundamentals,
    description: '3D visualization of refrigerant line routing, sizing, and proper installation techniques for optimal system performance.',
  ...
  },
  {
    ...
    title: 'AC Types',
    category: VideoCategory.hvacFundamentals,
    description: 'Overview of different air conditioning system types including split systems, package units, heat pumps, and ductless mini-splits.',
    url: 'https://youtu.be/moBjCghTCsE?si=HlTEqhfn8dRD30CW',
    linkedLessonTopic: 'Fundamentals - AC System Types',
    duration: BigInt(2100),
  ...
  // Diagnostics & Tools Videos
  {
    ...
    description: 'Proper evacuation techniques using vacuum pumps, achieving deep vacuum levels, and verifying system integrity before charging.',
  ...
  },
  {
    ...
    category: VideoCategory.diagnosticsMeasurements,
    description: 'Measuring and interpreting AC system pressures and subcooling for proper system charging and performance diagnosis.',
  ...
  },
  {
    ...
    title: 'Recovery 3D',
    category: VideoCategory.diagnosticsMeasurements,
    description: '3D visualization of refrigerant recovery procedures, equipment setup, and EPA-compliant recovery techniques.',
  ...
  },
  {
    ...
    title: 'Multimeter 3D',
    category: VideoCategory.diagnosticsMeasurements,
    description: '3D demonstration of digital multimeter operation for testing voltage, amperage, and resistance in HVAC electrical systems.',
  ...
  },
  {
    ...
    title: 'Gauges',
    category: VideoCategory.diagnosticsMeasurements,
    description: 'Proper manifold gauge setup, pressure reading interpretation, and troubleshooting techniques using gauge readings.',
  ...
  },
  {
    ...
    category: VideoCategory.diagnosticsMeasurements,
    description: 'Step-by-step vacuum pump operation, micron gauge usage, and achieving proper vacuum levels for system evacuation.',
  ...
  // Electrical Controls Videos
  {
    ...
    description: 'Understanding low voltage control systems, thermostat wiring, and 24V control circuits in HVAC equipment.',
    url: 'https://youtu.be/5UU2c5e2ork?si=5QNU1mMVHLg3gvd-',
  ...
  },
  {
    ...
    category: VideoCategory.electricalControls,
    description: 'Proper testing procedures for relays, contactors, and transformers using multimeters and diagnostic techniques.',
  ...
  },
  {
    ...
    category: VideoCategory.electricalControls,
    description: 'Complete guide to thermostat wiring including color codes, common wire issues, and smart thermostat installation.',
  ...
  // EPA Playlists
  {
    ...
    description: 'Complete EPA 608 certification preparation playlist covering Core, Type I, Type II, Type III, and Universal certification content.',
  ...
  },
  {
    ...
    category: VideoCategory.epaPlaylists,
    description: 'Comprehensive HVAC fundamentals playlist covering refrigeration cycle, system components, diagnostics, and troubleshooting techniques.',
