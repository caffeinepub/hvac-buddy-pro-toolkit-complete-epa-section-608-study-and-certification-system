    ...
    <div className="space-y-6">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Capture images of refrigerant labels, wiring diagrams, or components
            for instant identification and guidance
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              Take a clear photo of refrigerant labels, wiring diagrams, or HVAC
              components. The AI will identify the item and provide relevant
