...
import {
  ...
  type RefrigerantSpec,
  filterRefrigerants,
  searchRefrigerants,
} from "@/data/refrigerantDatabase";
import {
  AlertTriangle,
  BookOpen,
  Database,
...
const MOCK_PARTS_DATABASE: HVACPart[] = [
  {
    ...
    description:
      "High-pressure refrigerant for residential and light commercial AC systems. Replaces R-22.",
  ...
  },
  {
    ...
    soundLevel: "72 dB",
    description:
      "High-efficiency scroll compressor for residential AC and heat pump applications.",
  ...
  },
  {
    ...
    weight: "45 lbs",
    description:
      "A-frame evaporator coil with aluminum fins and copper tubing for optimal heat transfer.",
  ...
  },
  {
    ...
    description:
      "WiFi-enabled programmable thermostat with 7-day scheduling and mobile app control.",
  ...
  },
  {
    ...
    description:
      "High-efficiency pleated air filter capturing 98% of airborne particles.",
  ...
  },
  {
    ...
    soundLevel: "74 dB",
    description:
      "High-efficiency outdoor condensing unit with scroll compressor and aluminum coil.",
...
export default function PartsTab() {
  ...
  const [selectedRefrigerant, setSelectedRefrigerant] =
    useState<RefrigerantSpec | null>(null);
  const [refrigerantSearch, setRefrigerantSearch] = useState("");
  const [refrigerantTypeFilter, setRefrigerantTypeFilter] =
    useState<string>("All");
  ...
  const filteredParts = MOCK_PARTS_DATABASE.filter((part) => {
    ...
    const matchesManufacturer =
      ...
      part.manufacturer === selectedManufacturer;
        ...
        <CardHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <CardDescription>
                Comprehensive HVAC component specifications with search,
          ...
          {compareList.length > 0 && (
            <Alert>
              ...
              <AlertDescription className="flex items-center justify-between">
                <span>
                  {compareList.length} part{compareList.length > 1 ? "s" : ""}{" "}
          ...
          <div className="space-y-3">
            {filteredParts.length === 0 ? (
              <Alert>
                ...
                <AlertDescription>
                  No parts found matching your search criteria. Try adjusting
                    ...
                    <div className="flex items-center gap-2">
                      <Checkbox
                        ...
                        disabled={
                          ...
                          !compareList.some((p) => p.id === part.id)
                        }
                      />
                      <Button
                        variant="outline"
      ...
      >
        <DialogContent className="max-w-6xl max-h-[90vh]">
          <DialogHeader>
            ...
            <DialogDescription>
              Complete technical specifications for common HVAC refrigerants
              including GWP, ODP, pressures, and safety information
            </DialogDescription>
          </DialogHeader>
          ...
          <div className="space-y-4">
                ...
                <TableBody>
                  {filteredRefrigerants.map((ref) => (
                    ...
                    >
                      ...
                      <TableCell className="text-right">
                        {ref.evapPressure40Fpsig.toFixed(1)} psig
                      </TableCell>
            ...
            <div className="text-center text-sm text-muted-foreground">
              Showing {filteredRefrigerants.length} of{" "}
              {REFRIGERANT_DATABASE.length} refrigerants
            </div>
          </div>
        </DialogContent>
      </Dialog>
      ...
      >
        <DialogContent className="max-w-3xl">
          <DialogHeader>
            ...
            <DialogDescription>
              {selectedRefrigerant?.type} • ASHRAE Class{" "}
              {selectedRefrigerant?.ashraeClass}
            </DialogDescription>
          </DialogHeader>
          {selectedRefrigerant && (
              ...
              <div className="space-y-6">
                ...
                {selectedRefrigerant.a2lWarning && (
                  <Alert className="border-orange-600 bg-orange-50 dark:bg-orange-950">
                    ...
                    <AlertDescription className="text-orange-900 dark:text-orange-100">
                      <strong>A2L Refrigerant:</strong> Mildly flammable.
                      Requires specialized equipment, training, and safety
                      precautions. Follow manufacturer guidelines and local
                      codes.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                {selectedRefrigerant.ashraeClass.startsWith("B") && (
                  <Alert variant="destructive">
                    ...
                    <AlertDescription>
                      <strong>Toxic Refrigerant:</strong> Higher toxicity
                      classification. Requires proper ventilation, leak
                      detection, and safety equipment. Follow OSHA and EPA
                      guidelines.
                    </AlertDescription>
                  </Alert>
                )}
                ...
                {selectedRefrigerant.ashraeClass.includes("3") && (
                  <Alert variant="destructive">
                    <AlertTriangle className="h-4 w-4" />
                    <AlertDescription>
                      <strong>Highly Flammable:</strong> Class A3 refrigerant.
                      Extreme fire hazard. Requires specialized training,
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="rounded-lg border border-border p-3">
                      ...
                      <p className="text-2xl font-bold text-primary">
                        {selectedRefrigerant.gwp.toLocaleString()}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {selectedRefrigerant.gwp < 150
                          ? "Ultra-low GWP"
                          : selectedRefrigerant.gwp < 700
                            ? "Low GWP"
                            : selectedRefrigerant.gwp < 2000
                              ? "Medium GWP"
                              : "High GWP"}
                      </p>
                    </div>
                    <div className="rounded-lg border border-border p-3">
                      ...
                      <p className="text-2xl font-bold text-primary">
                        {selectedRefrigerant.odp.toFixed(3)}
                      </p>
                      <p className="text-xs text-muted-foreground">
                        {selectedRefrigerant.odp === 0
                          ? "No ozone depletion"
                          : "Ozone depleting"}
                      </p>
                    </div>
                ...
                <div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    ...
                    <div>
                      <p className="text-sm font-medium">
                        Typical Evap Sat Temp
                      </p>
                      <p className="text-sm text-muted-foreground">
                        {selectedRefrigerant.typicalEvapSatTempF.toFixed(0)}°F
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">
                        Typical Cond Sat Temp
                      </p>
                      <p className="text-sm text-muted-foreground">
                        {selectedRefrigerant.typicalCondSatTempF.toFixed(0)}°F
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Temperature Glide</p>
                      <p className="text-sm text-muted-foreground">
                        {selectedRefrigerant.glideF.toFixed(1)}°F
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">
                        {selectedRefrigerant.oilType}
                      </p>
                    </div>
                    <div>
                      <p className="text-sm font-medium">Charging Method</p>
                      <p className="text-sm text-muted-foreground">
                        {selectedRefrigerant.chargingMethod}
                      </p>
                    </div>
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    {selectedRefrigerant.typicalApplications}
                  </p>
                </div>
            ...
            <Tabs defaultValue="specs" className="w-full">
              ...
              <TabsContent value="specs" className="space-y-4">
                <ScrollArea className="h-[400px] pr-4">
                  <div className="space-y-4">
                    ...
                    {selectedPart.certifications &&
                      selectedPart.certifications.length > 0 && (
                        <>
                          <Separator />
                          <div>
              ...
              <TabsContent value="compatibility" className="space-y-4">
                <ScrollArea className="h-[400px] pr-4">
                  ...
                  selectedPart.compatibility.length > 0 ? (
                    <div className="space-y-2">
                      <h4 className="font-semibold">Compatible Systems</h4>
                      <ul className="space-y-2">
                        {selectedPart.compatibility.map((item, idx) => (
                          <li
                            // biome-ignore lint/suspicious/noArrayIndexKey: compatibility items have no stable ID
                            key={idx}
      ...
      <Dialog open={showResources} onOpenChange={setShowResources}>
        <DialogContent className="max-w-2xl">
          <DialogHeader>
            ...
            <DialogDescription>
              Access legitimate HVAC specification resources from manufacturers
          ...
          <ScrollArea className="h-[500px] pr-4">
            <div className="space-y-6">
              <div>
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    >
                      <ExternalLink className="mr-2 h-4 w-4" />
                      Carrier - Product Line Specifications & Installation
                      Manuals
                    </a>
                  </Button>
                  <Button
              ...
              <div>
                <h3 className="mb-3 text-lg font-semibold">
                  Orlando-Area Suppliers (Example)
                </h3>
                <p className="mb-3 text-sm text-muted-foreground">
                  Local supplier locations for reference. Contact directly for
                ...
                <div className="space-y-2">
                  ...
                  <div className="rounded-lg border border-border p-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Commercial and residential HVAC supplies
                    </p>
                  </div>
                  <div className="rounded-lg border border-border p-3">
                    <p className="font-medium">Baker Distributing - Orlando</p>
                    <p className="text-sm text-muted-foreground">
                      Full-line HVAC distributor
                    </p>
                  </div>
                </div>
              </div>
              ...
              <Alert>
                <Info className="h-4 w-4" />
                <AlertDescription>
                  <strong>Note:</strong> Always verify specifications with
                  manufacturer documentation before installation. Links provided
                  are for reference and educational purposes.
                </AlertDescription>
              </Alert>
            </div>
          </ScrollArea>
