...
export const diagnosticFlows: Record<string, DiagnosticFlowDefinition> = {
    ...
    steps: [
      {
        ...
        question:
          "Is the thermostat set to COOL mode and below room temperature?",
        explanation:
      ...
      },
      {
        ...
        safetyWarning:
          "Ensure proper ventilation when taking measurements near the unit.",
      ...
      },
      {
        ...
        category: "Deeper Inspection",
        question:
          "Are there any signs of refrigerant leaks (oil stains, bubbles, electronic leak detector)?",
        explanation:
  ...
  "no-heating": {
    name: "No Heating",
    description:
      "Diagnostic flow for heating systems not providing adequate heat",
    steps: [
      {
        id: "thermostat-heat",
        ...
        category: "Basic Checks",
        question:
          "Is the thermostat set to HEAT mode and above room temperature?",
        explanation:
          "Verify the thermostat is calling for heat and set to the correct mode.",
        inputType: "yesNo",
      },
      {
        id: "power-heat",
        ...
        explanation:
          "Check circuit breakers and disconnect switches for the heating system.",
        inputType: "yesNo",
      },
      {
        id: "filter-heat",
        ...
        explanation:
          "A dirty filter can cause the system to overheat and shut down on the limit switch.",
        inputType: "choice",
      ...
      },
      {
        ...
        category: "Deeper Inspection",
        question:
          "Is the ignition system functioning (pilot light or electronic ignition)?",
        explanation:
          "For gas furnaces, verify the ignition source is working properly.",
        safetyWarning:
          "If you smell gas, evacuate immediately and call the gas company. Do not attempt repairs.",
        inputType: "yesNo",
      },
      {
        id: "flame-sensor",
        ...
        explanation:
          "A dirty flame sensor can cause the burner to shut off after a few seconds.",
        inputType: "choice",
    ...
    steps: [
      {
        ...
        explanation:
          "Normal cycles should be 10-15 minutes. Shorter cycles indicate a problem.",
        inputType: "number",
      ...
      },
      {
        ...
        category: "Basic Checks",
        question:
          "Is the thermostat in a good location (away from drafts, direct sunlight, heat sources)?",
        explanation:
          "Poor thermostat placement can cause false readings and short cycling.",
        inputType: "yesNo",
      },
      {
        id: "filter-cycling",
        ...
        question: "Is the air filter clean?",
        explanation:
          "A dirty filter can cause the system to overheat and cycle on the limit switch.",
        inputType: "choice",
      ...
      },
      {
        ...
        explanation:
          "Low refrigerant can cause short cycling due to low pressure cutout.",
        inputType: "yesNo",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        explanation:
          "A tripped breaker is the most common cause of no power. Check both indoor and outdoor breakers.",
        inputType: "yesNo",
      },
      {
        id: "disconnect-check",
        ...
        explanation:
          "The disconnect switch may have been turned off for maintenance or accidentally.",
        inputType: "yesNo",
      },
      {
        id: "fuse-check",
        ...
        explanation:
          "Blown fuses indicate an electrical problem that must be diagnosed before replacement.",
        safetyWarning:
          "Turn off power before inspecting fuses. Use proper safety equipment.",
        inputType: "choice",
      ...
      },
      {
        ...
        explanation:
          "No display may indicate a blown transformer or wiring issue.",
        inputType: "yesNo",
      },
      {
        id: "contactor-check",
        ...
        category: "Deeper Inspection",
        question:
          "Does the contactor pull in when the thermostat calls for cooling?",
        explanation:
          "A failed contactor or coil will prevent the compressor and fan from running.",
        safetyWarning:
          "Do not touch electrical components while power is on. Use insulated tools.",
        inputType: "yesNo",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        explanation:
          "The extent of ice buildup helps determine thaw time and severity of the underlying issue.",
        inputType: "choice",
        options: [
          "Light frost",
          "Partial ice",
      ...
      },
      {
        ...
        explanation:
          "The coil must thaw completely before diagnosis can continue. This may take 2-8 hours.",
        safetyWarning:
          "Place towels or a pan under the unit to catch water from melting ice.",
        inputType: "yesNo",
      },
      {
        id: "filter-frozen",
        ...
        explanation:
          "A dirty filter is the most common cause of frozen coils due to restricted airflow.",
        inputType: "choice",
        options: [
          "Clean",
          "Slightly dirty",
      ...
      },
      {
        ...
        explanation:
          "A slow or failing blower motor reduces airflow, causing the coil to freeze.",
        inputType: "choice",
        options: [
          "Normal speed",
          "Running slow",
      ...
      },
      {
        ...
        explanation:
          "Low refrigerant charge causes low evaporator pressure and temperature, leading to freezing.",
        inputType: "yesNo",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        explanation:
          "Quantifying the airflow helps determine the severity of the restriction.",
        inputType: "choice",
        options: [
          "Slightly weak",
          "Moderately weak",
      ...
      },
      {
        ...
        explanation:
          "Closed or blocked vents reduce airflow and can cause system problems.",
        inputType: "yesNo",
      },
      {
        id: "return-vents",
        ...
        explanation:
          "Blocked return vents starve the system of air, reducing overall airflow.",
        inputType: "yesNo",
      },
      {
        id: "blower-airflow",
        ...
        explanation:
          "A failing blower motor or capacitor can cause reduced airflow.",
        inputType: "yesNo",
      },
      {
        id: "ductwork-check",
        ...
        explanation:
          "Leaky or disconnected ducts waste conditioned air and reduce airflow to living spaces.",
        inputType: "choice",
        options: [
          "No leaks visible",
          "Minor leaks",
    ...
    steps: [
      {
        ...
        explanation:
          "Indoor humidity should typically be 30-50%. Higher levels indicate a dehumidification problem.",
        inputType: "number",
      ...
      },
      {
        ...
        explanation:
          "Short cycles (under 10 minutes) do not allow adequate dehumidification.",
        inputType: "choice",
      ...
      },
      {
        ...
        explanation:
          "A clogged drain can cause water backup and humidity problems.",
        inputType: "yesNo",
      },
    ],
  },
    ...
    steps: [
      {
        ...
        explanation:
          "The timing of the trip helps identify the failing component.",
        inputType: "choice",
        options: [
      ...
      },
      {
        ...
        explanation:
          "Check the unit nameplate and compare to breaker amperage rating.",
        safetyWarning:
          "Never install a larger breaker without verifying wire gauge is adequate.",
        inputType: "yesNo",
      },
      {
        id: "compressor-amps",
        ...
        explanation:
          "High amp draw indicates a failing compressor or electrical problem.",
        safetyWarning:
          "Use a clamp meter to measure amps. Do not touch live wires.",
        inputType: "number",
      ...
      },
      {
        ...
        explanation:
          "A weak or failed capacitor causes high amp draw and can trip the breaker.",
        inputType: "choice",
  ...
  "unusual-noises": {
    ...
    steps: [
      ...
      },
      {
        ...
        explanation:
          "Damaged or dirty fan blades can cause rattling or grinding noises.",
