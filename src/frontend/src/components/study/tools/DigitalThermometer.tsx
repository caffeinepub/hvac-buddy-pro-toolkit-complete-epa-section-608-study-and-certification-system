...
import { AlertTriangle, CheckCircle2, Info, Thermometer } from "lucide-react";
...
export default function DigitalThermometer({
  studyMode,
}: DigitalThermometerProps) {
      ...
      <CardContent className="space-y-6">
        {isBeginner && (
          <Alert>
            ...
            <AlertDescription>
              Superheat measures how much vapor is heated above saturation
              temperature. Subcooling measures how much liquid is cooled below
              condensing temperature. Both indicate proper system charge.
            </AlertDescription>
          </Alert>
        )}
        ...
        <Alert>
          ...
          <AlertDescription>
            ...
            {superheat < 5 &&
              "Low superheat indicates possible overcharge or TXV malfunction. "}
            {superheat > 15 &&
              "High superheat indicates possible undercharge or restricted metering device. "}
            {subcooling < 7 &&
              "Low subcooling indicates possible undercharge. "}
            {subcooling > 18 &&
              "High subcooling indicates possible overcharge or restricted liquid line. "}
            {superheat >= 8 &&
              superheat <= 12 &&
              subcooling >= 10 &&
              subcooling <= 15 &&
