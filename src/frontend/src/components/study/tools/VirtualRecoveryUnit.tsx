...
export default function VirtualRecoveryUnit({
  studyMode,
}: VirtualRecoveryUnitProps) {
  ...
  const refrigerantData = {
    ...
    "R-134a": { totalCharge: 4.5, maxCylinderPressure: 200, recoveryRate: 0.1 },
    "R-404A": {
      totalCharge: 7.0,
      maxCylinderPressure: 350,
      recoveryRate: 0.13,
    },
  };

  const currentRefrigerant =
    refrigerantData[refrigerantType as keyof typeof refrigerantData];
  const recoveryProgress =
    (recoveredAmount / currentRefrigerant.totalCharge) * 100;
  const allSafetyChecksComplete = Object.values(safetyChecks).every(
    (check) => check,
  );
    ...
    if (isRecovering && allSafetyChecksComplete) {
      const interval = setInterval(() => {
        ...
        setSystemPressure((prev) => {
          const newPressure =
            prev -
            (120 / currentRefrigerant.totalCharge) *
              currentRefrigerant.recoveryRate;
        ...
        setCylinderPressure((prev) => {
          const newPressure =
            prev +
            (currentRefrigerant.maxCylinderPressure /
              currentRefrigerant.totalCharge) *
              currentRefrigerant.recoveryRate;
      ...
      <CardContent className="space-y-6">
        {isBeginner && (
          <Alert>
            ...
            <AlertDescription>
              Recovery units remove refrigerant from systems for service or
              disposal. EPA regulations require recovery to specific vacuum
              levels. Always use certified recovery equipment and proper
              cylinders. Push-pull method is fastest but requires liquid and
              vapor connections.
            </AlertDescription>
          </Alert>
        )}
        ...
        <div className="grid gap-4 md:grid-cols-2">
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={setRefrigerantType}
          ...
          <div className="space-y-2">
            ...
            <Select
              value={recoveryMode}
              onValueChange={(v) => setRecoveryMode(v as typeof recoveryMode)}
              disabled={isRecovering}
            >
              <SelectTrigger>
                <SelectValue />
                ...
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setSafetyChecks((prev) => ({
                      ...prev,
                      cylinderVerified: checked as boolean,
                    }))
                  }
                  disabled={isRecovering}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setSafetyChecks((prev) => ({
                      ...prev,
                      hoseConnected: checked as boolean,
                    }))
                  }
                  disabled={isRecovering}
                />
              ...
              <div className="flex items-center space-x-2">
                <Checkbox
                  ...
                  onCheckedChange={(checked) =>
                    setSafetyChecks((prev) => ({
                      ...prev,
                      scaleZeroed: checked as boolean,
                    }))
                  }
                  disabled={isRecovering}
                />
        ...
        {!allSafetyChecksComplete && (
          <Alert variant="destructive">
            ...
            <AlertDescription>
              Complete all safety checks before starting recovery. Improper
              procedures can cause equipment damage, refrigerant loss, or
              personal injury.
            </AlertDescription>
          </Alert>
        )}
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-lg font-semibold">
                        {currentRefrigerant.totalCharge} lbs
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Card>
                <CardContent className="p-4">
                  ...
                  <p className="text-2xl font-bold">
                    {systemPressure.toFixed(1)} PSI
                  </p>
                  <Progress
                    value={(systemPressure / 120) * 100}
                    className="mt-2 h-2"
                  />
                </CardContent>
              </Card>
              ...
              <Card>
                <CardContent className="p-4">
                  ...
                  <p className="text-2xl font-bold">
                    {cylinderPressure.toFixed(1)} PSI
                  </p>
                  <Progress
                    value={
                      (cylinderPressure /
        ...
        {recoveryProgress >= 100 && (
          <Alert className="border-green-500/50 bg-green-500/10">
            ...
            <AlertDescription>
              <strong>Recovery Complete!</strong> System pressure has reached
              required vacuum level. Close valves, disconnect hoses, and label
              recovery cylinder with refrigerant type and weight.
            </AlertDescription>
          </Alert>
        )}
          ...
          <Card className="border-primary/20 bg-primary/5">
            <CardContent className="p-4">
              ...
              <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
                ...
                <li>
                  Recover to required vacuum levels (varies by system type)
                </li>
                <li>
