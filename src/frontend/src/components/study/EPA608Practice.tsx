...
export default function EPA608Practice({
  certType,
  studyMode,
}: EPA608PracticeProps) {
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: allQuestions changes when certType changes
  useEffect(() => {
  ...
  const updatePerformanceScore = (isCorrect: boolean) => {
    ...
    if ((currentQuestion + 1) % 3 === 0) {
      ...
      if (recentPerformance > 0.8 && adaptiveDifficulty !== "hard") {
        ...
        setAdaptiveDifficulty(
          adaptiveDifficulty === "hard" ? "medium" : "easy",
        );
      }
    }
  };
        ...
        <Card className={passed ? "border-green-500" : "border-yellow-500"}>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Award
                className={`h-6 w-6 ${passed ? "text-green-500" : "text-yellow-500"}`}
              />
              ...
              <Card className="border-yellow-500/30 bg-yellow-500/5">
                ...
                <CardContent>
                  ...
                  <p className="mt-3 text-sm text-muted-foreground">
                    Performance below 70% in these areas. Review the study
                    content for these topics before retaking the exam.
                  </p>
                </CardContent>
              </Card>
            )}
      ...
      <Card>
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2">
                ...
                <span>{selectedAnswers.filter((a) => a).length} answered</span>
              </div>
            </div>
            <Progress
        ...
        <CardContent className="space-y-6">
          ...
          {showExplanation && isAnswered && (
            <Alert
              className={isCorrect ? "border-green-500" : "border-yellow-500"}
            >
              <div className="flex items-start gap-2">
                {isCorrect ? (
...
function getQuestions(certType: string): Question[] {
  const coreQuestions: Question[] = [
    {
      ...
      options: [
        ...
        "Regulate refrigerant prices",
        "Standardize recovery equipment",
      ],
      correctAnswer: "Phase out ozone-depleting substances",
      explanation:
        "The Montreal Protocol is an international treaty designed to phase out the production and use of ozone-depleting substances to protect the stratospheric ozone layer.",
      difficulty: "easy",
    ...
    },
    {
      ...
      correctAnswer: "R-12",
      explanation:
        "R-12 is a CFC with an ODP of 1.0, the baseline for measuring ozone depletion. R-410A and R-134a are HFCs with zero ODP.",
      difficulty: "easy",
    ...
    },
    {
      ...
      options: [
        ...
        "Gas Weight Pressure",
        "General Working Pressure",
        "Greenhouse Warning Protocol",
      ],
      correctAnswer: "Global Warming Potential",
      explanation:
        "GWP measures a refrigerant's heat-trapping ability compared to CO2 over a 100-year period.",
      difficulty: "easy",
      objective: "Environmental impact assessment",
    },
    {
      question:
        "What is the maximum penalty for knowingly venting refrigerants?",
      options: [
      ...
      explanation:
        "EPA can fine up to $44,539 per day for knowingly venting refrigerants under Section 608 of the Clean Air Act.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "EPA requires refrigerant records to be maintained for at least 3 years for systems with 50+ lbs charge.",
      difficulty: "easy",
    ...
    },
    {
      ...
      explanation:
        "Passive recovery (gravity method) does not meet EPA requirements. Active recovery using certified equipment is required.",
      difficulty: "medium",
      objective: "Recovery procedures and equipment",
    },
    {
      question:
        "What is the required recovery level for high-pressure systems with operating compressors?",
      options: [
        "0 psig",
        "4 inches Hg vacuum",
        "10 inches Hg vacuum",
      ...
      explanation:
        "High-pressure systems with operating compressors must be recovered to 10 inches Hg vacuum before opening the system.",
      difficulty: "medium",
      objective: "Recovery procedures for different system types",
    },
    {
      question:
        "What is the maximum liquid fill capacity for recovery cylinders?",
      options: ["60%", "70%", "80%", "90%"],
      correctAnswer: "80%",
      explanation:
        "Recovery cylinders must never be filled above 80% liquid capacity to allow for thermal expansion and prevent cylinder rupture.",
      difficulty: "medium",
      objective: "Refrigerant storage and handling safety",
    },
    {
      question:
        "Which organization certifies recovery equipment to industry standards?",
      options: ["EPA", "AHRI", "ASHRAE", "OSHA"],
      correctAnswer: "AHRI",
      explanation:
        "AHRI (Air-Conditioning, Heating, and Refrigeration Institute) certifies recovery equipment to ARI 740 standards.",
      difficulty: "hard",
      objective: "Equipment certification and standards",
    },
    {
      question:
        "What is the leak rate threshold requiring repair for comfort cooling systems?",
      options: ["5%", "10%", "20%", "35%"],
      correctAnswer: "10%",
      explanation:
        "Comfort cooling systems must repair leaks if the annual leak rate exceeds 10% of the full charge.",
      difficulty: "hard",
    ...
    },
    {
      ...
      explanation:
        "One chlorine atom can destroy over 100,000 ozone molecules through a catalytic chain reaction, demonstrating the severe impact of CFCs.",
      difficulty: "hard",
    ...
    },
    {
      ...
      correctAnswer: "0.055",
      explanation:
        "HCFC-22 has an ODP of 0.055, significantly lower than CFCs but still contributing to ozone depletion, which is why it is being phased out.",
      difficulty: "hard",
  ...
  const type1Questions: Question[] = [
    {
      question:
        "What is the maximum amount of refrigerant in a small appliance?",
      options: [
        "5 pounds or less",
        "10 pounds or less",
        "15 pounds or less",
      ...
      explanation:
        "Small appliances are defined as containing 5 pounds or less of refrigerant under EPA Section 608 regulations.",
      difficulty: "easy",
    ...
    },
    {
      ...
      explanation:
        "Small appliances must be recovered to 0 psig (atmospheric pressure) before disposal. No vacuum is required.",
      difficulty: "easy",
      objective: "Recovery requirements for small appliances",
    },
    {
      question:
        "Which type of recovery equipment is required for small appliances?",
      options: [
      ...
      explanation:
        "Small appliances require self-contained (active) recovery equipment that uses its own compressor. Passive recovery is not EPA-compliant.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Refrigerant must be recovered to 0 psig before disposal to prevent environmental release and comply with EPA regulations.",
      difficulty: "easy",
      objective: "Disposal procedures and environmental protection",
    },
    {
      question:
        "Which refrigerant is commonly found in household refrigerators manufactured after 1995?",
      options: ["R-12", "R-22", "R-134a", "R-410A"],
      correctAnswer: "R-134a",
      explanation:
        "R-134a replaced R-12 in household refrigerators after 1995. It is an HFC with zero ODP but has a GWP of 1,430.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Common leak locations include compressor terminals (vibration), evaporator coils (corrosion), and filter drier connections (poor brazing).",
      difficulty: "medium",
      objective: "Leak detection in small appliances",
    },
    {
      question:
        "What safety hazard must be addressed before servicing small appliances?",
      options: [
        "High voltage",
        "Capacitor discharge",
      ...
      correctAnswer: "All of the above",
      explanation:
        "Small appliances present multiple hazards: high voltage from power supply, capacitor discharge (can be lethal), and refrigerant under pressure.",
      difficulty: "hard",
      objective: "Safety procedures for small appliance service",
    },
    {
      question:
        "What is the target vacuum level for evacuating a small appliance after repair?",
      options: [
        "100 microns",
        "500 microns",
        "1000 microns",
      ...
      explanation:
        "After leak repair, evacuate to 500 microns or below to remove air and moisture. This ensures proper system operation and prevents acid formation.",
      difficulty: "hard",
      objective: "Evacuation procedures for small appliances",
    },
    {
      question:
        "How long should a vacuum be held to verify no leaks in a small appliance?",
      options: ["5 minutes", "15 minutes", "30 minutes", "1 hour"],
      correctAnswer: "30 minutes",
      explanation:
        "Hold vacuum for 30 minutes and monitor for pressure rise. If pressure remains stable, system is leak-free and ready for charging.",
      difficulty: "medium",
    ...
    },
    {
      ...
      options: [
        "Vapor charge only",
        "Liquid charge only",
        "Weigh in exact charge",
        "Charge by pressure",
      ],
      correctAnswer: "Weigh in exact charge",
      explanation:
        "Small appliances have critical charges and must be charged by weight to manufacturer specifications. Overcharging or undercharging reduces efficiency.",
      difficulty: "hard",
  ...
  const type2Questions: Question[] = [
    {
      question:
        "What is the required recovery level for high-pressure systems with a non-functioning compressor?",
      options: [
        "0 psig",
        "4 inches Hg vacuum",
        "10 inches Hg vacuum",
      ...
      correctAnswer: "0 psig",
      explanation:
        "Systems with non-functioning compressors must be recovered to 0 psig. Systems with operating compressors require 10 inches Hg vacuum.",
      difficulty: "medium",
      objective: "Recovery requirements for high-pressure systems",
    },
    {
      question:
        "Which refrigerant is commonly used in modern residential air conditioning?",
      options: ["R-22", "R-410A", "R-12", "R-502"],
      correctAnswer: "R-410A",
      explanation:
        "R-410A is the current standard for residential AC systems, replacing R-22. It has zero ODP but a GWP of 2,088.",
      difficulty: "easy",
      objective: "Refrigerant identification in high-pressure systems",
    },
    {
      question:
        "What is the leak rate threshold requiring repair for commercial refrigeration?",
      options: ["10%", "20%", "35%", "50%"],
      correctAnswer: "35%",
      explanation:
        "Commercial refrigeration with 50+ lbs must repair if annual leak rate exceeds 35%. Comfort cooling threshold is 10%.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Leak repairs must be completed and verified within 30 days of detection using initial verification test. Follow-up verification required within 12 months.",
      difficulty: "medium",
    ...
    },
    {
      ...
      correctAnswer: "500 microns",
      explanation:
        "Target vacuum level is 500 microns or below to ensure removal of air and moisture. Use electronic vacuum gauge for accurate measurement.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Push-pull method connects liquid line to recovery machine inlet and vapor line to outlet, significantly speeding up recovery process.",
      difficulty: "hard",
      objective: "Advanced recovery techniques",
    },
    {
      question:
        "What pressure should nitrogen be used for leak testing high-pressure systems?",
      options: ["50 psig", "100 psig", "150 psig", "200 psig"],
      correctAnswer: "150 psig",
      explanation:
        "Pressurize to 150 psig with dry nitrogen for leak testing (or system test pressure, whichever is lower). Never exceed manufacturer test pressure.",
      difficulty: "hard",
    ...
    },
    {
      ...
      explanation:
        "Triple evacuation (evacuate, break with nitrogen, repeat) is most effective at removing moisture from systems that have been open to atmosphere.",
      difficulty: "hard",
    ...
    },
    {
      ...
      options: [
        "Vacuum improves",
        "Vacuum stays constant",
        "Vacuum rises (pressure increases)",
        "Vacuum gauge fails",
      ],
      correctAnswer: "Vacuum rises (pressure increases)",
      explanation:
        "If vacuum rises (pressure increases) during hold test, system has a leak. Stable vacuum indicates leak-free system ready for charging.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Filter driers remove moisture, acid, and contaminants from refrigerant. Replace after system has been open or contaminated to prevent compressor damage.",
      difficulty: "medium",
  ...
  const type3Questions: Question[] = [
    {
      ...
      explanation:
        "Low-pressure systems must be recovered to 25mm Hg absolute (equivalent to 29 inches Hg vacuum) before opening the system.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Centrifugal chillers typically use R-123 and operate at low pressure (below atmospheric pressure in evaporator).",
      difficulty: "easy",
    ...
    },
    {
      ...
      correctAnswer: "R-123",
      explanation:
        "R-123 is commonly used in low-pressure centrifugal chillers. It is an HCFC with low ODP (0.02) and allows efficient operation at low pressures.",
      difficulty: "easy",
      objective: "Refrigerant identification in low-pressure systems",
    },
    {
      question:
        "Why are low-pressure systems more prone to air and moisture contamination?",
      options: [
      ...
      explanation:
        "Operating below atmospheric pressure (vacuum) allows air and moisture to enter through leaks rather than refrigerant escaping.",
      difficulty: "medium",
    ...
    },
    {
      ...
      explanation:
        "Purge units automatically remove non-condensable gases (air) that accumulate in low-pressure systems, maintaining efficiency.",
      difficulty: "medium",
      objective: "Purge unit operation and purpose",
    },
    {
      question:
        "What is the maximum pressure for leak testing low-pressure systems with nitrogen?",
      options: ["10 psig", "50 psig", "100 psig", "150 psig"],
      correctAnswer: "10 psig",
      explanation:
        "Low-pressure systems have lower test pressures than high-pressure systems. Typically pressurize to 10 psig maximum to avoid damage.",
      difficulty: "hard",
    ...
    },
    {
      ...
      correctAnswer: "B1",
      explanation:
        "R-123 is classified as B1: higher toxicity (B) but non-flammable (1). Requires refrigerant monitors and adequate ventilation.",
      difficulty: "hard",
      objective: "Refrigerant safety classifications",
    },
    {
      question:
        "What is the recommended ventilation rate for R-123 mechanical rooms?",
      options: [
        "0.25 cfm/sq ft",
        "0.5 cfm/sq ft",
        "1.0 cfm/sq ft",
      ...
      explanation:
        "Mechanical rooms with R-123 require minimum 0.5 cfm per square foot ventilation to maintain safe air quality.",
      difficulty: "hard",
      objective: "Safety requirements for low-pressure systems",
    },
    {
      question:
        "How often should a properly maintained low-pressure system purge?",
      options: [
        "Every hour",
        "4 times per day",
        "Once per day",
      ...
      explanation:
        "A leak-free, properly maintained low-pressure system should purge no more than 4 times per day. Frequent purging indicates leaks.",
      difficulty: "medium",
      objective: "System maintenance and leak detection",
    },
    {
      question:
        "What is the typical approach temperature for a properly operating condenser?",
      options: ["1-2°F", "2-4°F", "5-7°F", "8-10°F"],
      correctAnswer: "2-4°F",
      explanation:
        "Approach temperature (difference between leaving water temp and condensing temp) should be 2-4°F. Higher values indicate fouled tubes or poor water flow.",
      difficulty: "hard",
