...
import { BookOpen, Info, X, ZoomIn } from "lucide-react";
          ...
          <Tabs defaultValue="theory" className="w-full">
            ...
            <TabsContent value="theory" className="space-y-4 pt-4">
              ...
              <div className="prose prose-sm dark:prose-invert max-w-none">
                {lessonContent.theory.map((section, idx) => (
                  <div
                    // biome-ignore lint/suspicious/noArrayIndexKey: sections are static and order-stable
                    key={idx}
                    className="mb-6"
                  >
            ...
            <TabsContent value="diagrams" className="space-y-4 pt-4">
              <Alert className="border-primary/20 bg-primary/5">
                ...
                <AlertDescription>
                  <strong>Interactive Diagrams:</strong> Click on any diagram to
                  zoom in for detailed examination. Hover over images to see key
                  concepts.
                </AlertDescription>
              </Alert>
            ...
            <TabsContent value="formulas" className="space-y-4 pt-4">
              <div className="space-y-4">
                {lessonContent.formulas.map((formula, idx) => (
                  <Card
                    // biome-ignore lint/suspicious/noArrayIndexKey: formulas are static and order-stable
                    key={idx}
                  >
                    <CardContent className="pt-6">
                      <div className="mb-2 font-mono text-base sm:text-lg font-semibold text-primary break-all">
                        {formula.formula}
                      </div>
      ...
      diagrams: [
        {
          ...
          description:
            "Illustration of conduction, convection, and radiation heat transfer methods used in HVAC systems",
          tooltip:
            "This diagram shows the three fundamental heat transfer methods: conduction through solid materials, convection through fluid movement, and radiation through electromagnetic waves.",
          accessibilityText:
            "Diagram illustrating three heat transfer methods: conduction, convection, and radiation with arrows showing heat flow direction",
        },
        {
          title: "Pressure-Temperature Relationship",
          image: "/assets/generated/pressure-gauge.dim_400x300.jpg",
          description:
            "Pressure gauge showing the relationship between refrigerant pressure and temperature",
          tooltip:
            "Pressure and temperature are directly related in refrigerants. Higher pressure means higher boiling point temperature, which is critical for the refrigeration cycle operation.",
          accessibilityText:
            "Pressure gauge with measurement scales showing pressure-temperature correlation for refrigerants",
        },
      ],
      formulas: [
        {
          ...
          formula: "Q = m × c × ΔT",
          explanation:
            "Heat required to change temperature without phase change. Q=heat, m=mass, c=specific heat, ΔT=temperature change",
        ...
        },
        {
          ...
          formula: "Q = m × L",
          explanation:
            "Heat required for phase change at constant temperature. L is the latent heat of vaporization or fusion",
      ...
      diagrams: [
        {
          ...
          image:
            "/assets/generated/refrigeration-cycle-diagram.dim_800x600.jpg",
          description:
            "Full refrigeration cycle showing evaporator, compressor, condenser, and expansion valve with refrigerant state changes",
          tooltip:
            "This diagram shows the refrigerant flow through the complete cycle: evaporating in the indoor coil (absorbing heat), being compressed, condensing in the outdoor coil (releasing heat), and expanding back to low pressure.",
          accessibilityText:
            "Complete refrigeration cycle diagram with four main components: evaporator, compressor, condenser, and expansion valve, showing refrigerant flow and state changes",
        },
      ],
      formulas: [
        {
          ...
          explanation:
            "Calculate cooling capacity based on airflow (CFM) and temperature difference",
        ...
        },
        {
          ...
          explanation:
            "Efficiency ratio - higher COP means more efficient system",
      ...
      diagrams: [
        {
          ...
          description:
            "Professional HVAC tools used for airflow measurement and system diagnostics",
          tooltip:
            "These tools are essential for measuring airflow, static pressure, and system performance. Proper measurement techniques ensure accurate diagnostics and optimal system operation.",
          accessibilityText:
            "Collection of HVAC diagnostic tools including pressure gauges, thermometers, and airflow measurement devices",
        },
      ],
      formulas: [
        {
          ...
          explanation:
            "Calculate airflow volume from duct area and air velocity",
        ...
        },
        {
          ...
          explanation:
            "Determine required airflow for desired cooling capacity",
          example:
            "For 24,000 BTU/hr with 20°F ΔT: CFM = 24,000/(1.08×20) = 1,111 CFM",
        },
      ],
    },
    electrical: {
      ...
      diagrams: [
        {
          ...
          description:
            "Typical residential HVAC electrical schematic showing control and power circuits with safety devices",
          tooltip:
            "This wiring diagram shows the electrical connections between the thermostat, control board, compressor, fan motor, and safety devices. Understanding these connections is essential for troubleshooting electrical issues.",
          accessibilityText:
            "Detailed electrical wiring schematic for residential HVAC system showing thermostat connections, control circuits, power circuits, and safety interlocks",
        },
      ],
      formulas: [
        {
