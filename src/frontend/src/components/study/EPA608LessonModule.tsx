...
import { Info, Shield, AlertTriangle, Lightbulb, BookOpen, CheckCircle2, ExternalLink, PlayCircle, List } from 'lucide-react';
...
export default function EPA608LessonModule({
  ...
  const sectionVideos = allVideos.filter(v => v.category === categoryMap[section]);
        ...
        <CardContent>
          <Tabs defaultValue="theory" className="w-full">
            ...
            <TabsContent value="theory" className="space-y-4 pt-4">
              {isBeginner && (
                <Alert>
                  ...
                  <AlertDescription>
                    Take your time to understand each concept. This material is essential for EPA 608 certification.
                  </AlertDescription>
                </Alert>
              )}
              ...
              <div className="prose prose-sm dark:prose-invert max-w-none">
                ...
                {lesson.diagrams.length > 0 && (
                  <div className="mt-6 space-y-4">
                    <h4 className="text-base font-semibold">Visual Learning Aids</h4>
                    {lesson.diagrams.map((diagram, idx) => (
                      <div key={idx} className="space-y-2">
                        ...
                        <div className="rounded-lg border border-primary/20 bg-primary/5 p-3">
                          ...
                          <p className="mt-1 text-sm text-foreground">{diagram.caption}</p>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <TabsContent value="safety" className="space-y-4 pt-4">
              <Alert className="border-yellow-500/50 bg-yellow-500/10">
                ...
                <AlertDescription className="text-yellow-900 dark:text-yellow-100">
                  Safety is paramount. Always follow proper procedures and use appropriate protective equipment.
                </AlertDescription>
              </Alert>
            ...
            <TabsContent value="examples" className="space-y-4 pt-4">
              <div className="space-y-3">
                <h3 className="text-lg font-semibold">Real-World HVAC Examples</h3>
                <p className="text-sm text-muted-foreground">
                  These examples connect theory to practical field applications and diagnostic workflows.
                </p>
            ...
            <TabsContent value="terms" className="space-y-4 pt-4">
              <div className="space-y-3">
                <h3 className="text-lg font-semibold">Key Terms and Definitions</h3>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      <CardTitle className="text-base">Scenario-Based Practice</CardTitle>
                      <div className="flex items-center gap-2">
                        <Badge variant="outline">{currentPractice.difficulty}</Badge>
                        <span className="text-sm text-muted-foreground">
                          {currentScenario + 1} of {lesson.practiceScenarios.length}
                        </span>
                      </div>
                    </div>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="rounded-lg bg-muted/50 p-4">
                      ...
                      <p className="mt-2 text-sm text-muted-foreground">{currentPractice.scenario}</p>
                    </div>

                    <div>
                      <p className="mb-3 font-medium">{currentPractice.question}</p>
                      <div className="space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            ...
                            <AlertDescription className="mt-1">
                              <strong>Explanation:</strong> {currentPractice.explanation}
                            </AlertDescription>
                            {!isCorrect && (
                              <AlertDescription className="mt-2">
                                <strong>Correct Answer:</strong> {currentPractice.correctAnswer}
                              </AlertDescription>
                            )}
                          </div>
                        </div>
                    ...
                    <Button onClick={handleNextScenario} disabled={!selectedAnswer} className="w-full">
...
function getLessonModule(section: string, moduleId: string): LessonModule | null {
  const modules: Record<string, Record<string, LessonModule>> = {
        ...
        practiceScenarios: [
          {
            ...
            question: 'What is the annual leak rate, and does it require repair under EPA regulations?',
            options: [
            ...
            correctAnswer: '40% leak rate - repair required for commercial refrigeration',
            explanation:
          ...
          },
          {
            ...
            question: 'What is the correct explanation for why venting is prohibited?',
            options: [
          ...
          },
          {
            ...
            correctAnswer: 'Yes - 15% leak rate exceeds 10% threshold for comfort cooling',
            explanation:
        ...
        practiceScenarios: [
          {
            ...
            question: 'What should you do before connecting your recovery equipment?',
            options: [
          ...
          },
          {
            ...
            question: 'What special precautions are required for A2L refrigerants?',
            options: [
        ...
        practiceScenarios: [
          {
            ...
            correctAnswer: 'Failed compressor with open windings - requires replacement',
            explanation:
    ...
    type2: {
      'high-pressure-systems': {
        ...
        title: 'Module 1: High-Pressure System Identification and Characteristics',
        theory:
        ...
        practiceScenarios: [
          {
            ...
            correctAnswer: '10 inches Hg vacuum - required for high-pressure systems with operating compressor',
            explanation:
          ...
          },
          {
            ...
            question: 'What is the annual leak rate and what action is required?',
            options: [
          ...
          },
          {
            ...
            correctAnswer: '150 psig - standard test pressure for high-pressure systems, or system test pressure if lower',
            explanation:
        ...
        practiceScenarios: [
          {
            ...
            correctAnswer: '25mm Hg absolute (29 inches Hg vacuum) - required for low-pressure systems',
            explanation:
          ...
          },
          {
            ...
            question: 'What is the correct test pressure for low-pressure systems?',
            options: [
            ...
            correctAnswer: '10 psig maximum - low-pressure systems not rated for high pressure',
            explanation:
      ...
      'comprehensive-regulatory': {
        ...
        practiceScenarios: [
          ...
          },
          {
            ...
            question: 'Which systems require leak repair under EPA regulations?',
            options: [
